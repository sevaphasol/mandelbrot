    ...
    <tr>
        ...
        <td>
            <table>
            	...
            	<tr><th>BASELINE</th><th>(384.0 ± 0.5)⋅10⁶</th></tr>
...
- O1 уже хранит переменные в регистрах, что резко сокращает время выполнения (в ~8.6 раз быстрее, чем O0).
...
Здесь я перевожу курсор мыши на разные строки C-кода
